...
module.exports = function (app, plugin) {
  return {
    ...
    optionKey: 'Moon',
    title:
      'Sets environment.moon.* information such as phase, rise, and set (based on navigation.datetime or system time and navigation.position)',
    ...
    calculator: function (datetime, position) {
      ...
      var times = suncalc.getMoonTimes(date, position.latitude, position.longitude)
      ...
      return [
        ...
        { path: 'environment.moon.times.alwaysUp', value: times.alwaysUp? "true" : "false" },
        { path: 'environment.moon.times.alwaysDown', value: times.alwaysDown? "true" : "false" }
      ]
    }
  }
}
